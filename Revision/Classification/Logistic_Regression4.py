...
model = LogisticRegression(penalty="l2",solver="lbfgs",C=0.01,max_iter=1000)
...
grid = GridSearchCV(estimator=LogisticRegression(max_iter=1000),param_grid=param,scoring="accuracy",cv=5)
