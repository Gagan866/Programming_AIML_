...
# RocCurveDisplay.from_estimator(model,y1[x],y1[y])
# plt.show()
# RocCurveDisplay.from_predictions(result['y_test'],result['y_pred'])
# plt.show()
...
grid = GridSearchCV(model2,parameters,cv=5,scoring="accuracy",n_jobs=-1)
grid.fit(x1[x],x1[y])

print("Best params",grid.best_params_)
print("Before",accuracy_score(result['y_test'],result['y_pred']))
