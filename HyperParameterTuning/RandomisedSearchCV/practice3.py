...
randomr_dt = RandomizedSearchCV(DecisionTreeClassifier(random_state=42),
                                n_iter=20,
                                random_state=42,
...
randomr_dt.fit(X_train, y_train)

print("\n===== Hyperparameter Tuning Results =====")
print("Best Parameters:", randomr_dt.best_params_)
print("Best CV Accuracy:", randomr_dt.best_score_)

# 5. Best Model
best_dt = randomr_dt.best_estimator_
